...
public class Matricad {
    ...
    public Matricad(String[] dada) {
        if ((dada == null) || (dada.length == 0)) {
            // Verifiquem que la llista tinga valors  
    ...
    /**
     * @return la cadena que té més caràcters. La primera si hi ha diverses amb
     * la mateixa longitud
     */
     ...
     * @throws java.util.NoSuchElementException Si l'element no existeix en la
     * llista
     */
